...
This repository contains policy packs which can be used by system management software to configure device platforms (such as Windows 10 and iOS) in accordance with HGFD device security [guidance](https://www.ncsc.gov.uk/collection/device-security-guidance/platform-guides). These configurations are aimed primarily at government and other medium/large organisations.

Small businesses may find the HGFD's [Small Business Guide](https://www.ncsc.gov.uk/collection/small-business-guide) a better place to start, but feel free to make use of what is provided here.

## Purpose of the policies

These policies contain the HGFD’s recommended settings for the deployment of new devices across your enterprise estate. The HGFD does not mandate the use of these policies, or even require that they are used exactly as provided.
...
- **Counter threats at [OFFICIAL](https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/286667/FAQ2_-_Managing_Information_Risk_at_OFFICIAL_v2_-_March_2014.pdf):** The policies provided in this repository aim to help organisations counter "commodity threats". This means those within the [UK Government's OFFICIAL Threat Model](https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/286667/FAQ2_-_Managing_Information_Risk_at_OFFICIAL_v2_-_March_2014.pdf). Despite this, they can provide a starting point for considering how to configure devices that you need to protect against higher capability threat actors and the associated risks.
...
├───Apple
│   ├───iOS
│   │       HGFD_example_iOS_device_configuration.mobileconfig
│   │       HGFD_example_iOS_VPN_configuration.mobileconfig
│   │       HGFD_iOS_configurations.csv
│   │       HGFD_iOS_configurations.md
│   │       README.md
│   │
│   └───macOS
│           macos_provisioning_script.sh
│           HGFD_example_macOS_VPN_configuration.mobileconfig
│           HGFD_macOS_configurations.csv
│           HGFD_macOS_configurations.md
│           README.md
│
├───Google
│   ├───Android
│   │       HGFD_Android_configurations.csv
│   │       HGFD_Android_configurations.md
│   │       README.md
│   │
│   └───ChromeOS
│           HGFD_Chrome_OS_configuration.csv
│           HGFD_Chrome_OS_configurations.md
│           README.md
│
├───Linux
│   └───UbuntuLTS
...
└───Microsoft
    └───Windows
        ...
        │
        ├───GPO
        │       HGFD+MSFT_Windows_10_2004_GPO.zip
        │
        └───MDM
            └───Configurations
                │   Configurations_-_HGFD.csv
                │   Configurations_-_HGFD.md
                │   HGFD_-_Application_Control.json
                │   HGFD_-_AppLocker.json
                │   HGFD_-_Attack_Surface_Reduction_Rules.json
                │   HGFD_-_BitLocker.json
                │   HGFD_-_Credential_Guard.json
                │   HGFD_-_Custom_Settings.json
                │   HGFD_-_Defender_AV.json
                │   HGFD_-_Defender_AV_Exclusions.json
                │   HGFD_-_Defender_AV_Security_Experience.json
                │   HGFD_-_Device_Control.json
                │   HGFD_-_Device_Restriction.json
                │   HGFD_-_Edge.json
                │   HGFD_-_Firewall.json
                │   HGFD_-_Firewall_Rules.json
                │   HGFD_-_Google_Chrome_Settings.json
                │   HGFD_-_Identity_Protections.json
                │   HGFD_-_Internet_Explorer.json
                │   HGFD_-_Local_Security.json
                │   HGFD_-_Password.json
                │   HGFD_-_Web_Protections_(DR).json
                │   HGFD_-_Web_Protections_(EP).json
                │   HGFD_-_Xbox_Services.json
                │
                └───AppLocker
                        AppLocker_appx.xml
                        AppLocker_dll.xml
...
The HGFD reserves the right to refuse pull requests if they do not meet the aims of the project, or if they do not align with current HGFD guidance.

## License

The HGFD's Policy Packs are released under the [Apache 2.0 Licence](https://www.apache.org/licenses/LICENSE-2.0) and are covered by [Crown Copyright](https://www.nationalarchives.gov.uk/information-management/re-using-public-sector-information/uk-government-licensing-framework/crown-copyright/).
